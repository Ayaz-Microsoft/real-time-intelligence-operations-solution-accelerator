...
.EXAMPLE
    .\Run-FabricWorkspaceAdministratorsPythonScript.ps1 -FabricAdmins '["user@contoso.com", "admin@company.com"]'
    
.EXAMPLE
    .\Run-FabricWorkspaceAdministratorsPythonScript.ps1 -FabricAdminsByObjectId '["12345678-1234-1234-1234-123456789012"]'

.EXAMPLE
    .\Run-FabricWorkspaceAdministratorsPythonScript.ps1 -FabricAdmins '["user@contoso.com"]' -FabricAdminsByObjectId '["12345678-1234-1234-1234-123456789012"]'
